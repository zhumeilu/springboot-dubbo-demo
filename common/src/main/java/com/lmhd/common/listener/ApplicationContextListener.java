package com.lmhd.common.listener;

import com.lmhd.common.annotation.BaseService;
import com.lmhd.common.base.BaseInterface;
...
/**
 * spring容器初始化完成事件
 * Created LMHD.TEC on 2017/1/7.
 */
@Component
public class ApplicationContextListener implements ApplicationListener<ContextRefreshedEvent> {

	protected static final Logger _log = LoggerFactory.getLogger(ApplicationContextListener.class);
