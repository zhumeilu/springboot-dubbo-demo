...
public final class DataUtil {
	...
	public static String fmtNum4thousands(Number num) {
		return new DecimalFormat(",##0.00").format(num);
	}

	public static String fmtNum4thousands2(Number num) {
		return new DecimalFormat(",##0.000").format(num);
	}

	public static String fmtNum4thousands3(Number num) {
		return new DecimalFormat("##0.000").format(num);
	}

	public static void main(String[] args) {
		System.out.println(fmtNum4thousands2(2123.456));
		//		System.out.println(fmtNum4thousands(1007));
		//		System.out.println(fmtNum4thousands(10100));
		//		System.out.println(fmtNum4thousands(10030.05d));
		//		System.out.println(fmtNum4thousands(15000.056f));
		//		System.out.println(fmtNum4thousands(new BigDecimal("12307.05")));
		//		System.out.println(fmtNum4thousands(new BigDecimal(0).setScale(2)));
	}
}
